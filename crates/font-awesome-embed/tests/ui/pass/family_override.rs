...
fn main() {
    let _: &str = fa!("house", solid, family = classic);
    let _: &str = fa!("house", solid, family = etch);
    let _: &str = fa!("house", regular, family = chisel);
    let _: &str = fa!("house", solid, family = sharp);
    let _: &str = fa!("house", solid, family = sharp_duotone);
    let _: &str = fa!("house", solid, family = duotone);
    let _: &str = fa!("house", thin, family = graphite);
